...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected Bob but got Sue. Queue is not returning people in the correct order.
    ...
    // Defect(s) Found: Expected Bob but got Sue. Same ordering issue as above.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected Bob but got Sue. Same ordering issue.
    ...
    // Defect(s) Found: Expected Tim but got Sue. Same ordering issue.
